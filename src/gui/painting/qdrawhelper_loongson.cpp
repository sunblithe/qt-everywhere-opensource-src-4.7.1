...
CompositionFunction qt_functionForMode_LSSIMD[numCompositionFunctions] = {
	...
	comp_func_DestinationOver_lssimd,
	comp_func_Clear_lssimd,
	comp_func_Source_lssimd,
	comp_func_Destination,
    comp_func_SourceIn_lssimd,
    comp_func_DestinationIn_lssimd,
    comp_func_SourceOut_lssimd,
    comp_func_DestinationOut_lssimd,
    comp_func_SourceAtop_lssimd,
    comp_func_DestinationAtop_lssimd,
    comp_func_XOR_lssimd,
    comp_func_Plus,
    comp_func_Multiply,
    comp_func_Screen,
    comp_func_Overlay,
